const checkMoveability = (x1, y1, x2, y2, data) =>{
...
const pawnMoveability = (x1, y1, x2, y2, data, color) => {
...
const bishopMoveability = (x1, y1, x2, y2, data, color) =>{
...
const rookMoveability = (x1, y1, x2, y2, data, color) =>{
...
const knightMoveability = (x1, y1, x2, y2, data, color) =>{
    const dx = Math.abs(x2 - x1);
    const dy = Math.abs(y2 - y1);
...
const queenMoveability = (x1, y1, x2, y2, data, color) =>{
    const dx = Math.abs(x2 - x1);
    const dy = Math.abs(y2 - y1);
...
const kingMoveability =(x1, y1, x2, y2, data, color) => {
    const dx = Math.abs(x2 - x1);
    const dy = Math.abs(y2 - y1);
